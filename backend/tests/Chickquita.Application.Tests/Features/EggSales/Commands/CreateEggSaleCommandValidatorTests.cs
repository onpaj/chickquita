...
/// <summary>
/// Unit tests for CreateEggSaleCommandValidator.
/// Tests all validation rules for the CreateEggSaleCommand.
/// </summary>
public class CreateEggSaleCommandValidatorTests
{
    private readonly CreateEggSaleCommandValidator _validator;

    public CreateEggSaleCommandValidatorTests()
    {
        _validator = new CreateEggSaleCommandValidator();
    }
    ...
    public void Validate_WithValidNotes_ShouldNotHaveValidationError()
    {
        ...
        var command = new CreateEggSaleCommand
        {
            ...
            Quantity = 100,
            PricePerUnit = 5.00m,
            Notes = "Weekly batch to local market"
        };
    ...
    [Fact]
    public void Validate_WithMinimalValidCommand_ShouldNotHaveAnyValidationErrors()
    {
        // Arrange
        var command = new CreateEggSaleCommand
        {
